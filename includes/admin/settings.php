...
class styleAdmin {
	...
	function styleGuideMenus() {
		add_menu_page( 'SG-60', 'SG-60', 'delete_pages', 'style-guide-main', array( $this, 'styleGuideMain' ), 'dashicons-welcome-write-blog', 90 );
			...
			echo '<tbody>';
				...
				endwhile;
					...
					echo '<tr><td colspan="3" align="center">No Style Guides Created <br/><br/>';
						echo '<a class="button button-primary" href="'.admin_url('post-new.php?post_type=style-guides').'">Create SG-60 Style Guide</a>';
					echo '</td>';
				endif;
			echo '</tbody>';
		echo '</table>';
		    ...
		    echo '<table width="100% cellpadding="5" cellspacing="0" border="0" id="bottomTable">';
		    	echo '<thead>';
		    		echo '<tr><td colspan="2"><div>';
		    			...
		    			echo '</div><div class="text-center"><a class="button button-primary" href="'.admin_url('post-new.php?post_type=style-guides').'">Create SG-60 Style Guide</a>';
		    		echo '</div></td></td>';
		    		echo '<tr>';
		    			echo '<th><h3>SG-60 Style Guide Creator</h3></th>';
		    			echo '<th><h3>SG-60 &amp; ARC(CTRL) NEWS</h3></th>';
		    		echo '<tr>';
		    	echo '</thead>';
		    	echo '<tbody>';		    		
		    		echo '<tr>';
